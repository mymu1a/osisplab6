...
const char *gengetopt_args_info_purpose = "Lab6 2024 osisp";

const char *gengetopt_args_info_usage = "Usage: sort_index [OPTION]... [FILE]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -m, --memsize=INT      размер рабочего буфера, кратный размеру страницы\n                           (getpagesize())",
  "  -b, --blocks=INT       порядок разбиения буфера",
  "  -t, --threads=INT      количество потоков (от k до N)",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->memsize_help = gengetopt_args_info_help[2] ;
  args_info->blocks_help = gengetopt_args_info_help[3] ;
...
{
  unsigned int i;
  free_string_field (&(args_info->memsize_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->memsize_given)
    write_into_file(outfile, "memsize", args_info->memsize_orig, 0);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVm:b:t:f:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'm':	/* размер рабочего буфера, кратный размеру страницы (getpagesize()).  */
        
        
          if (update_arg( (void *)&(args_info->memsize_arg), 
               &(args_info->memsize_orig), &(args_info->memsize_given),
              &(local_args_info.memsize_given), optarg, 0, 0, ARG_INT,
        ...
        case 'b':	/* порядок разбиения буфера.  */
          ...
          break;
        case 't':	/* количество потоков (от k до N).  */
